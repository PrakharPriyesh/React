...
class Home extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            products: {
                ...
                "x6": { name: "Decoration", price: 100, img: "https://i.dlpng.com/static/png/345312_preview.png", stock: 100, count: 0 },
                ...
                "x12": { name: "Decoration", price: 100, img: "https://i.dlpng.com/static/png/345312_preview.png", stock: 100, count: 0 },
    ...
    addItemToCartHandler = (id) => {
        ...
        const cart_products = { ...this.state.cart_products }
